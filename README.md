the HBnB project implemets the back-end console of a web application cloning AirBnB.

The console serves as a command line interpreter enabling the administration of HBnB's backend. It facilitates the manipulation and management of all classes employed within the application through calls made to the previously defined storage object.
